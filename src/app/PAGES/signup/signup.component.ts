...
export class SignupComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private signupService: SignupService, private router: Router, private fireAuth: AngularFireAuth, private db: AngularFirestore,private signinService: SigninService) { }
